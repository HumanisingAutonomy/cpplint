...
line_length_data = [
    ['// Hello',''],
    ['// x' + ' x' * 40, 'Lines should be <= 80 characters long  [whitespace/line_length] [2]'],
    ['// x' + ' x' * 50, 'Lines should be <= 80 characters long' '  [whitespace/line_length] [2]'],
    ['// //some/path/to/f' + ('i' * 100) + 'le',''],
    ['//   //some/path/to/f' + ('i' * 100) + 'le',''],
    ['//   //some/path/to/f' + ('i' * 50) + 'le and some comments','Lines should be <= 80 characters long  [whitespace/line_length] [2]'],
    ['// http://g' + ('o' * 100) + 'gle.com/',''],
    ['//   https://g' + ('o' * 100) + 'gle.com/',''],
    ['//   https://g' + ('o' * 60) + 'gle.com/ and some comments', 'Lines should be <= 80 characters long  [whitespace/line_length] [2]'],
    ['// Read https://g' + ('o' * 60) + 'gle.com/',''],
    ['// $Id: g' + ('o' * 80) + 'gle.cc#1 $',''],
    ['// $Id: g' + ('o' * 80) + 'gle.cc#1', 'Lines should be <= 80 characters long  [whitespace/line_length] [2]'],
...
variable_declaration_data = [
    ['long a = 65;', 'Use int16/int64/etc, rather than the C type long  [runtime/int] [4]'],
    ['long double b = 65.0;', ''],
    ['long long aa = 6565;', 'Use int16/int64/etc, rather than the C type long  [runtime/int] [4]'],
]

c_style_cast_data = [
    ['int a = (int)1.0;', 'Using C-style cast.  Use static_cast<int>(...) instead  [readability/casting] [4]'],
    ['int a = (int)-1.0;', 'Using C-style cast.  Use static_cast<int>(...) instead  [readability/casting] [4]'],
    ['int *a = (int *)NULL;', 'Using C-style cast.  Use reinterpret_cast<int *>(...) instead  [readability/casting] [4]'],

    ['uint16 a = (uint16)1.0;', 'Using C-style cast.  Use static_cast<uint16>(...) instead  [readability/casting] [4]'],
    ['int32 a = (int32)1.0;', 'Using C-style cast.  Use static_cast<int32>(...) instead  [readability/casting] [4]'],
    ['uint64 a = (uint64)1.0;', 'Using C-style cast.  Use static_cast<uint64>(...) instead  [readability/casting] [4]'],
    ['size_t a = (size_t)1.0;', 'Using C-style cast.  Use static_cast<size_t>(...) instead  [readability/casting] [4]'],
...
_runtime_casting_error_msg = ('Are you taking an address of a cast?  '
    'This is dangerous: could be a temp var.  '
    'Take the address before doing the cast, rather than after'
    '  [runtime/casting] [4]')
_runtime_casting_alt_error_msg = ('Are you taking an address of something dereferenced '
...
runtime_self_init_data = [
    ['Foo::Foo(Bar r, Bel l) : r_(r_), l_(l_) { }', 'You seem to be initializing a member variable with itself.  [runtime/init] [4]'],
    ['Foo::Foo(Bar r, Bel l) : r_(CHECK_NOTNULL(r_)) { }', 'You seem to be initializing a member variable with itself.  [runtime/init] [4]'],
...
deprecated_cast_data = [
    ['int a = int(2.2);', 'Using deprecated casting style.  Use static_cast<int>(...) instead  [readability/casting] [4]'],
    ['(char *) "foo"', 'Using C-style cast.  Use const_cast<char *>(...) instead  [readability/casting] [4]'],
    ['(int*)foo', 'Using C-style cast.  Use reinterpret_cast<int*>(...) instead  [readability/casting] [4]'],
